...
export const BeerMenuList = [
    ...
    },
    {
        ...
        Mouthfeel:"Moderate carbination, medium-full body, and alcohol warm.",
        color: "",
        FoodParing: "",
        index: 1
    },
    {
        ...
        ABV: "6.0-12.0%",
        description:": Similar malt and hop flavors as the aroma (same descriptors apply). Moderately strong to aggressive bitterness,tempered by a rich, malty palate. Moderate to high hop flavor. Low to moderate esters. Noticeable alcohol, but not solventy. Moderately low to moderately high malty sweetness on the palate, with a somewhat malty to dry but full finish. Age will often dry out the beer, and smooth out the flavors. The balanceis malty, but always bitter. ",
        Aroma:"Hops, rich malt, Caramel sweetness.",
        Mouthfeel:"Moderate carbination, medium full bodied.",
        color: "Amber to medium copper, rarely up to light brown",
        FoodParing: "",
        index: 2
    },
    {
